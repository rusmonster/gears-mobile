...
The `/cf-sdlc-pr-review` workflow produces reports in `.prs/{ID}/review.md` following this structure.
...
- `{placeholders}` are filled by the LLM during the `/cf-sdlc-pr-review` workflow.
